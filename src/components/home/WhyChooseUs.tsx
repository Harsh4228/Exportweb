...
const features = [
  ...
  },
  {
    ...
    description: "Smooth exports by Sea, Air, or Courier, always within promised timeline.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, i) => (
            ...
            >
              <div className="bg-cream rounded-2xl p-7 h-full card-hover group text-center">
                <div className="w-14 h-14 rounded-xl bg-primary text-white flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform">
                  {feature.icon}
                </div>
